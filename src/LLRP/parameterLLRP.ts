...
import {
  ...
  LlrpFieldType,
  LlrpParameter,
} from "./interfaces/llrpParametersInterface";
...
export class LLRPParameter implements LlrpParameter {
  ...
  public getTypeName(): string {
    return parameterConstants[this.type.value];
  }
  ...
  public getEncoding(): number {
    if (this.isTV(this.type.value)) {
      return parameterConstants.ENCODING_TV;
    }

    return parameterConstants.ENCODING_TLV;
  }
